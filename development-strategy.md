...
- [x] Have a bunch of square images (hard code their order, use html)
- [x] Make them turn on click
- [x] Make their order random using javascript
- [ ] Turn them back around if you clicked two
- [x] Then implement the logic to only turn back if they don't match
